...
namespace ServiceReference1
{
    ...
    public partial class UslugaBIRzewnPublClient : System.ServiceModel.ClientBase<ServiceReference1.IUslugaBIRzewnPubl>, ServiceReference1.IUslugaBIRzewnPubl
    {
        ...
        public async void info()
        {
            ...
            DaneSzukajPodmiotyResponse res = await DaneSzukajPodmiotyAsync(req);

            XmlDocument xml = new XmlDocument();
            xml.LoadXml("<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\"" + " xmlns:ns=\"http://CIS/BIR/PUBL/2014/07\" xmlns:dat=\"http://CIS/BIR/PUBL/2014/07/DataContract\"> " +
            ...
            request.Method = "POST";
            request.ContentType = "application/soap+xm";
